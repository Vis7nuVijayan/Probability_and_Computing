...
public class Solution
{
	...
	public static final int ROUNDS_PER_M = 100;
	public static final int NO_OF_M = 10;
	...
	{
		int[] inputM = new int[NO_OF_M];
		int[] success = new int[NO_OF_M];
